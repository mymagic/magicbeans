...
Activity.create(name: 'Magicbeans',start_date: DateTime.new(2015,1,1,9,0,0,'+8'), end_date: DateTime.new(2015,1,31,5,0,0,'+8'),venue: 'SSTwo Mall, Seksyen 17',description: 'Rails Bootcamp',speaker: 'Imran Ismail',speakerbio: 'Rails Developer',biolink: 'www.imranismail.me',keytakeaway: 'Learn rails',prerequisite: 'SPM', maxattendee: 5,tags: 'web-dev, rails, programming',resources: "www.imranismail.me\r\nwww.rails.com",program_id: 1)
